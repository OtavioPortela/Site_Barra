...
class OrdemServicoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrdemServico
        fields = [
            'id', 'numero', 'cliente', 'cliente_id', 'cliente_nome', 'descricao', 'status',
            ...
            'observacoes', 'usuario_criacao', 'usuario_criacao_nome', 'itens'
        ]
...
class OrdemServicoListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrdemServico
        fields = [
            'id', 'numero', 'cliente', 'descricao', 'status',
            'valor', 'data_criacao', 'prazo_entrega', 'data_finalizacao', 'faturada'
        ]
