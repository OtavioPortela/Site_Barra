...
export const CreateClienteModal = ({ isOpen, onClose, onSuccess }: CreateClienteModalProps) => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            />
            {errors.cnpj_cpf && (
              <p className="mt-1 text-sm text-red-600">{errors.cnpj_cpf}</p>
            )}
          </div>
